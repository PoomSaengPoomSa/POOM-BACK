...
def get_schedules(
    ...
    """일정 전체 목록 조회"""
    return schedule_service.get_schedules(current_user, db)
...
def create_schedule(
    ...
    """일정 생성"""
    return schedule_service.create_schedule(request, current_user, db)
...
def get_schedule(
    ...
    """일정 상세 조회"""
    return schedule_service.get_schedule(schedule_id, current_user, db)
